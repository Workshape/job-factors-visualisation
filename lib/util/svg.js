...
/*
 * Create and return a SVG path element with given data and options
 *
 * @param {[Number]} d
 * @param {Object=} options
 * @return {SVGElement}
...
function path(d, options) {
    ...
    return svgElement('path', extend(options, { d: d }));
}
...
export default { svg, wrap, svgElement, sanitisePoints, image, text,  group, circle, rectangle, line, path };